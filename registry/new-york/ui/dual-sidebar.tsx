...
function SidebarProvider({
  ...
  const [_openLeft, _setOpenLeft] = React.useState(defaultOpen ?? defaultOpenLeft);
...
function SidebarTrigger({ className, onClick, side, ...props }: React.ComponentProps<typeof Button> & { side?: "left" | "right" }) {
